...
import "../components/Prototype.scss";
...
export default function Prototype() {
  ...
  return (
    <div className="prototype-content">
      ...
      <div className="prototype-features-content">
        <div
          ref={containerRef}
        ...
        >
          ...
          >
            ...
            >
              The stage of creating the first version
            </motion.h2>
      ...
      <div className="prototype-hero-content" ref={heroRef}>

        <motion.h2 style={{color: "#000"}} className="title-hero-content">The stage of building the first prototype.</motion.h2>
        <div className="images-content">
          ...
          <Link to="/antiracist-skeleton-app/sesion6" element={<Sesion6 />}>
            ...
            ><span>First version</span></motion.div>
          </Link>

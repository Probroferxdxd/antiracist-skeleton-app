...
export default function Empathize() {
  ...
  return (
    <div className="define-content">
      ...
      <div className="define-title-content">
        <motion.h1
      ...
      <div className="define-features-content"> {/* This div remains as a container for the whole section */}
        <div
          ref={containerRef}
        ...
        >
          ...
          >
            ...
            >
              The stage of defining the problem and goals
            </motion.h2>

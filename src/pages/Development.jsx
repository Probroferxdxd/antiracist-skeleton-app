...
import Sesion8 from "./Sesion8";
import Sesion9 from "./Sesion9";
import Sesion10 from "./Sesion10";
...
export default function Development() {
  ...
  const listProcess = [
    "Sketches, early concepts, testing small parts of the idea.",
    "Experiments or mini-trials done before building the prototype.",
    "Adjustments made based on early feedback or testing results.",
  ];
  ...
  return (
    <div className="development-content">
      ...
      <div className="development-title-content">
        <motion.h1
      ...
      <div className="development-features-content"> {/* This div remains as a container for the whole section */}
        <div
          ref={containerRef}
        ...
        >
          ...
          >
            ...
            >
             The stage of we explore ideas, test small parts, and improve them based on feedback before creating the prototype.
            </motion.h2>
